...
namespace Content.Scripts.Game {
  ...
  public static class ActorRegistry<T> where T : Component {
    ...
    public static T GetByActorId(int id) {
      return _byActorId.GetValueOrDefault(id);
    }
    ...
    public static bool TryGet(int actorId, out T component) {
      return _byActorId.TryGetValue(actorId, out component);
    }
